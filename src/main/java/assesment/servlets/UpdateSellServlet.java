...
@WebServlet(name = "updateSellServlet", urlPatterns = "/updateSell")
public class UpdateSellServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        int quantity_sell = Integer.parseInt(req.getParameter("quantity"));
        PrintWriter out = res.getWriter();

        InventoryDetailsService inventory = new InventoryDetailsServiceImpl();
        try {
            List<InventoryDetailsDTO> dtoList = inventory.updateBuy(itemName, quantity_sell);
